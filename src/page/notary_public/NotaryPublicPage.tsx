...
const NotaryPublicPage: React.FC = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const {data:services,isLoading}=useFetch<IService>('https://aadymart-backend.onrender.com/api/notary-public')
  // Hero slider images
  const heroImages = [
  ...
  const galleryImages: GalleryImage[] = [
    { id: '1', url: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=300&h=200&fit=crop', title: 'Document Signing', category: 'document' },
    { id: '2', url: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=300&h=200&fit=crop', title: 'Real Estate Closing', category: 'real-estate' },
    { id: '3', url: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=300&h=200&fit=crop', title: 'Mobile Notary Service', category: 'mobile' },
    { id: '4', url: 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=300&h=200&fit=crop', title: 'Business Contract Signing', category: 'business' }
  ];
...
<>
<Helmet>
        <title>Certified Notary Public Services | Aady Group </title>
        <meta
          name="description"
          content="Get your documents officially notarized and authenticated. Aady Group  provides fast, reliable, and certified notary public services for all legal needs in Bangladesh."
        />
        <meta
          name="keywords"
          content="notary public, document notarization, attestation, legal documents, certification, Bangladesh Aady Group "
        />
      </Helmet>
        ...
        <div className="absolute inset-0 flex items-center justify-center z-10">
          <div className="text-center text-white max-w-4xl px-6">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Professional, reliable notarization services for all your legal documents
            </p>
          </div>
        </div>
      ...
      <section className="py-16" style={{ backgroundColor: '#F7F7F7' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { icon: <FileText className="w-8 h-8" />, number: '10K+', label: 'Documents Notarized' },
              { icon: <Users className="w-8 h-8" />, number: '5K+', label: 'Satisfied Clients' },
              { icon: <ShieldCheck className="w-8 h-8" />, number: '15+', label: 'Years Experience' },
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl max-w-2xl mx-auto" style={{ color: '#222222' }}>
              Professional notarization services for all your personal and business needs
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service,idx) => (
              <ServiceCard api='notary-public' key={idx} service={service}></ServiceCard>
            ))}
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl" style={{ color: '#222222' }}>
              Examples of our professional notary services in action
            </p>
          </div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-6">
          ...
          <p className="text-xl text-white/90 mb-8">
            Our mobile notary services come to you for maximum convenience
          </p>
...
export default NotaryPublicPage;