...
import { Eye, EyeOff, Mail, Lock, LogIn, LoaderIcon,  } from 'lucide-react';
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg"
            >
           {loading?<LoaderIcon className='w-full mx-auto animate-spin'></LoaderIcon>:<p>Sign In</p>}
            </motion.button>
