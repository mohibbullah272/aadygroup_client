...
const ElectricalElectronicsPage: React.FC = () => {
  const [currentSlide, setCurrentSlide] = useState(0);
  const {data:services,isLoading}=useFetch<IService>('https://aadymart-backend.onrender.com/api/electric-electronics')
  // Hero slider images - electrical/lighting themed
  const heroImages = [
    ...
    "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=1200&h=600&fit=crop"
  ];
...
<>
<Helmet>
        <title>Professional Electric & Electronics Services | Aady Group </title>
        <meta
          name="description"
          content="Expert electric installation, repair, and electronic solutions in Bangladesh. Ensure safety and efficiency for your home or business with Aady Group  certified electricians."
        />
        <meta
          name="keywords"
          content=" electrician, electric services, electronics repair, wiring, installation, Bangladesh, Aady Group "
        />
      </Helmet>
    ...
    <div className="absolute inset-0 flex items-center justify-center z-10">
      <div className="text-center text-white max-w-4xl px-6">
        ...
        <p className="text-xl md:text-2xl mb-8 opacity-90">
          Powering your world with expert electric solutions and modern technology
        </p>
  ...
  <section className="py-16" style={{ backgroundColor: '#F7F7F7' }}>
    <div className="max-w-6xl mx-auto px-6">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
        {[
          { icon: <Zap className="w-8 h-8" />, number: '800+', label: 'Projects Completed' },
          { icon: <Users className="w-8 h-8" />, number: '5K+', label: 'Satisfied Customers' },
    ...
    <div className="max-w-6xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-xl max-w-2xl mx-auto" style={{ color: '#222222' }}>
          From basic installations to advanced automation, we power your vision with reliability
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <ServiceCard api='electric-electronics' service={service} key={index}></ServiceCard>
        ))}
      </div>
    </div>
  </section>
  ...
  <section className="py-20" style={{ backgroundColor: '#F7F7F7' }}>
    <div className="max-w-6xl mx-auto px-6">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold mb-6" style={{ color: '#1A1A1A' }}>
          Why Choose Our Electric Services
        </h2>
        <p className="text-xl" style={{ color: '#222222' }}>
          Professional expertise with safety and quality guaranteed
        </p>
      </div>
        ...
        {[
          {
            ...
            description: 'We use cutting-edge electric equipment and smart home technologies for maximum efficiency and convenience.'
          },
          {
            icon: <Shield className="w-12 h-12" />,
            title: 'Safety First',
            description: 'All installations comply with safety standards and regulations. We prioritize your safety in every project.'
          },
          {
            icon: <Settings className="w-12 h-12" />,
            title: '24/7 Support',
            description: 'Round-the-clock emergency services and maintenance support for all your electric needs.'
          }
        ].map((feature, index) => (
  ...
  <section className="py-20 relative overflow-hidden">
    ...
    <div className="relative max-w-4xl mx-auto text-center px-6">
      <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
        Need Electric Services?
      </h2>
      <p className="text-xl text-white/90 mb-8">
        Get expert electric solutions with professional installation and reliable service
      </p>
...
export default ElectricalElectronicsPage;